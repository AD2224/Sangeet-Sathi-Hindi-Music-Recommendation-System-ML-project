...
USAGE:
    Keep  hindi_songs_dataset_.csv  in the SAME folder as this file.
...
# 2.  LOAD CSV
# ──────────────────────────────────────────────────────────────
CSV_NAME = "hindi_songs_dataset_.csv"
...
class SangeetSathi(tk.Tk):
    ...
    def _build_input_panel(self):
        ...
        self.btn = tk.Button(row, text="🎵  Get Recommendations",
                             font=self.F_BTN, bg=self.ACCENT, fg="#16A6B9",
                             activebackground="#16A6B9", activeforeground="#16A6B9",
